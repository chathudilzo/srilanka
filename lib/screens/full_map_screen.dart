//run with PS D:\FLUTTER\srilanka> flutter run -d chrome --web-browser-flag "--disable-web-security" to avoid CORS errors
...
@override
  void initState() {
    ...
    super.initState();
    _setMarkers();
    wController.getLocationWeather(Placess[index].lat,Placess[index].long);
  }
            ...
            children: [
              ...
              Container( width: width*0.28,
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(colors: [Color.fromARGB(255, 180, 182, 182),Color.fromARGB(255, 4, 148, 192)]),
                                    borderRadius: BorderRadius.circular(10)
                                  ),
              ...
              children: [
                ...
                Container( width: width*0.9,
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      gradient: LinearGradient(colors: [Color.fromARGB(255, 239, 240, 240),Color.fromARGB(255, 20, 139, 218)]),
                                      borderRadius: BorderRadius.circular(10),
